...
const routes = [
    ...
    { path: 'gallery', loadChildren: () => __webpack_require__.e(/*! import() | pages-gallery-gallery-module */ "pages-gallery-gallery-module").then(__webpack_require__.bind(null, /*! ./pages/gallery/gallery.module */ "./src/app/pages/gallery/gallery.module.ts")).then(m => m.GalleryModule) },
    { path: '', pathMatch: 'full', redirectTo: '/form' },
    { path: 'inquiryform', loadChildren: () => __webpack_require__.e(/*! import() | pages-inquiryform-inquiryform-module */ "pages-inquiryform-inquiryform-module").then(__webpack_require__.bind(null, /*! ./pages/inquiryform/inquiryform.module */ "./src/app/pages/inquiryform/inquiryform.module.ts")).then(m => m.InquiryFormModule) },
];
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 29, vars: 4, consts: [[1, "app-layout"], ["nzCollapsible", "", "nzWidth", "256px", "nzBreakpoint", "md", 1, "menu-sidebar", 3, "nzCollapsed", "nzTrigger", "nzCollapsedChange"], [1, "sidebar-logo"], ["href", "https://www.coronaconstructioncompany.com", "target", "_blank"], ["src", "assets/img/Logo.png", "alt", "logo"], ["nz-menu", "", "nzTheme", "dark", "nzMode", "inline", 3, "nzInlineCollapsed"], ["nz-submenu", "", "nzOpen", "", "nzTitle", "Home", "nzIcon", "menu-fold"], ["nz-menu-item", "", "nzMatchRouter", ""], ["routerLink", "/welcome"], ["routerLink", "/gallery"], ["nz-submenu", "", "nzOpen", "", "nzTitle", "Form", "nzIcon", "form"], ["routerLink", "/inquiryform"], [1, "app-header"], [1, "header-trigger", 3, "click"], ["nz-icon", "", 1, "trigger", 3, "nzType"], [1, "inner-content"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_span_click_24_listener() { return ctx.isCollapsed = !ctx.isCollapsed; });
...
/* harmony import */ var _pages_inquiryform_inquiryform_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./pages/inquiryform/inquiryform.service */ "./src/app/pages/inquiryform/inquiryform.service.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        ...
        _pages_inquiryform_inquiryform_service__WEBPACK_IMPORTED_MODULE_13__["InquiryformService"]
    ], imports: [[
...
/*!**********************************************************!*\
  !*** ./src/app/pages/inquiryform/inquiryform.service.ts ***!
  \**********************************************************/
/*! exports provided: InquiryformService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InquiryformService", function() { return InquiryformService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
class InquiryformService {
    constructor(http) {
        this.http = http;
        this.api = 'https://mailthis.to/jordangaytan';
    }
    PostMessage(input) {
        return this.http.post(this.api, input, { responseType: 'text' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((response) => {
            if (response) {
                return response;
            }
        }, (error) => {
...
InquiryformService.ɵfac = function InquiryformService_Factory(t) { return new (t || InquiryformService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"])); };
InquiryformService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: InquiryformService, factory: InquiryformService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](InquiryformService, [{
...
module.exports = __webpack_require__(/*! C:\Users\jorda\Desktop\CoronaConstruction Company\coronaconstruction\src\main.ts */"./src/main.ts");
